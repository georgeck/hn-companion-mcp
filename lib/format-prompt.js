 ...
 * @returns User prompt
 */
export function getUserPrompt(postTitle, formattedComments) {
 ...
 */
export function createCommentPathIdMapping(comments) {
    const mapping = {};
 ...
 */
export function formatForClaude(post, comments) {
